            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Obx(() => ModeButtonWidget(
                        mode: ArticleEnquiryMode.ean,
                        isSelected: controller.selectedMode.value == ArticleEnquiryMode.ean,
                        onTap: () => controller.selectMode(ArticleEnquiryMode.ean),
                      )),
                  const SizedBox(width: 2),
                  Obx(() => ModeButtonWidget(
                        mode: ArticleEnquiryMode.article,
                        isSelected: controller.selectedMode.value == ArticleEnquiryMode.article,
                        onTap: () => controller.selectMode(ArticleEnquiryMode.article),
                      )),
                  const SizedBox(width: 2),
                  Obx(() => ModeButtonWidget(
                        mode: ArticleEnquiryMode.plu,
                        isSelected: controller.selectedMode.value == ArticleEnquiryMode.plu,
                        onTap: () => controller.selectMode(ArticleEnquiryMode.plu),
                      )),
                  ...
                  Expanded(
                    child: Obx(() => TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Enter ${controller.selectedMode.value.fullName} number',
                        filled: true,
                ...
                switch (controller.state.value) {
                  ...
                  case ArticleEnquiryState.loaded:
                    return controller.articleInfo.value != null
                        ? ArticleDetailsPageView(articleInfo: controller.articleInfo.value!)
                        : const SizedBox();
